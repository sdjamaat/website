        ...
        items={[
          {
            ...
            children: (
              <>
                <div style={{ textAlign: "center", paddingBottom: "1.3rem", paddingTop: ".5rem", fontSize: "1.2rem" }}>
                      ...
                      return (
                        <div key={index} style={{ borderLeft: "1px solid gray", paddingLeft: "1rem" }}>
                          ...
                          <p style={{ color: "gray", paddingBottom: ".2rem" }}>
                            Size: {(props.selections as any).hasOwnProperty(item.id) ? (props.selections as any)[item.id] : "Not Found"}
                          </p>
                        </div>
                      )
                    }
