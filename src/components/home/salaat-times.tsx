...
const TimesTable = ({ times }: { times: any }) => {
  const columns = [
    {
      title: "Salaat",
      dataIndex: "name",
  ...
  const data = [
    { key: "1", name: "Fajr End | Sunrise", time: convertTime(times.Sunrise) },
    { key: "2", name: "Zawaal", time: convertTime(times.Dhuhr) },
    { key: "3", name: "Magrib", time: convertTime(times.Maghrib) },
  ]
