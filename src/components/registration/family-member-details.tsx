...
const FamilyMemberInfoForm = ({ index }: { index: number }) => {
  return (
    <Card
    ...
    >
      <Form.Item
        ...
        rules={[
          { required: true, message: "Please input family member first name" },
        ]}
      >
        <Input />
      </Form.Item>
      ...
      <Form.Item
        ...
        rules={[
          { required: true, message: "Please input family member last name" },
        ]}
      >
        <Input />
      </Form.Item>
      ...
      <Form.Item
        ...
        rules={[
          { required: true, message: "Please input family member YOB" },
        ]}
      >
        <DatePicker
          picker="year"
...
const FamilyMemberDetails = ({ layout, setStep, values, setValues, numFamilyMembers }: any) => {
