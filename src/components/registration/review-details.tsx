    ...
    <ReviewDetailsWrapper>
        ...
        <ul>
          {!showFamilyDetails && (
            <li>
              ...
              {familyAffiliation.members[familyAffiliation.memberindex].firstname}
              ]
            </li>
          )}
          ...
          <li>
            Other titles:{" "}
            {personalDetails.othertitles.length !== 0 && personalDetails.othertitles[0]}
            {personalDetails.othertitles.length > 1 && `, ${personalDetails.othertitles[1]}`}
      ...
      {showFamilyDetails && (
        ...
        >
          <ul>
            ...
            <li>Jamaat registration status: {familyDetails.registrationStatus}</li>
      ...
      {showFamilyDetails && familyDetails.size > 1 && (
        <div className="members-content">
          ...
          >
            {familyMemberDetails.members.map((member: any, index: number) => {
              if (typeof member !== "undefined") {
                return (
                  ...
                  >
                    <p style={{ textAlign: "center", fontWeight: "bold", marginBottom: ".5rem" }}>
